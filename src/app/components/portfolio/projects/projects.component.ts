	...
	projects: Project[] = [
		{
			...
			name: "Task Manager",
			description:
				"Keep all of your 'to-dos' nice and tidy with this kanban style task manager containging a drag and drop UI to update task status.",
		...
		},
		{
			...
			name: "Diplomacy",
			description:
				"Keep track of and trade resources while playing the board game, Diplomacy, with this website. More features to come!",
			image: "diplomacy.png",
